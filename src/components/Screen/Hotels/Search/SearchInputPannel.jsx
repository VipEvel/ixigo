...
export default function SearchInputPannel({
  ...
  const [openRoomsAndGuestPopper, setOpenRoomsAndGuestPopper] = useState(false);
  ...
  useEffect(() => {
    ...
    setLocation(
      LOCATIONS.findIndex((item) => item.city === searchParams.get("location"))
    );
  ...
  return (
    <Stack
      ...
      sx={{
        // bgcolor: "#fab",
        backgroundImage: "linear-gradient(0deg,#15457b,#051423)",
        width: "fit-cintent",
        mx: "auto",
        py: 1,
        // px: 3,
    ...
    >
      ...
      >
        <Autocomplete
          ...
          onChange={(e, v) => {
            removeError();
            setLocation(v ? LOCATIONS.findIndex((i) => i.city == v.city) : "");
          }}
        ...
        >
          ...
          >
            <legend
              style={{
                fontSize: 12,
                color: openRoomsAndGuestPopper ? "#0770e4" : "#fff",
                textAlign: "left",
                marginLeft: "3px",
              }}
            >
              ...
              <Stack direction={"row"} justifyContent={"space-between"}>
                <Stack direction={"row"} alignItems={"center"} gap={0.5}>
                  ...
                  <Stack>
                    ...
                    <Typography fontSize={12}>Minimum 1</Typography>
                  </Stack>
                </Stack>
                <Stack
                  direction={"row"}
                ...
                >
                  ...
                  <Typography fontWeight={500} sx={{ width: 18 }}>
                    {rooms}
                  </Typography>
                  <Button
                    {...buttonProps}
                    onClick={() =>
                      setRooms((prev) => {
                        if (prev + 1 > guests) setGuests(prev + 1);
                        return prev + 1;
                      })
                    }
                    disabled={rooms === 20}
              ...
              <Stack direction={"row"} justifyContent={"space-between"}>
                <Stack direction={"row"} alignItems={"center"} gap={0.5}>
                  ...
                  <Stack>
                    ...
                    <Typography fontSize={12}>Including Children</Typography>
                  </Stack>
                </Stack>
                <Stack
                  direction={"row"}
